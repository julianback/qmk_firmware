...
[0] = LAYOUT(
    ...
    KC_HYPR, KC_LGUI, KC_LALT, KC_LCTL,  KC_ENT,   MO(2),   MO(1),  KC_SPC, KC_RCTL,   KC_LALT, KC_RGUI,   MO(3)
  ),
...
[1] = LAYOUT(
    ...
    KC_LSFT, XXXXXXX,   KC_P1,   KC_P2,   KC_P3, XXXXXXX, XXXXXXX, XXXXXXX, KC_COMM, KC_KP_DOT, XXXXXXX, XXXXXXX,
    KC_HYPR, KC_LGUI, KC_LALT, KC_LCTL,  KC_ENT, XXXXXXX, _______, XXXXXXX, XXXXXXX,   XXXXXXX, KC_RGUI, XXXXXXX
  ),
...
[3] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   KC_LALT, XXXXXXX, _______
  ),
