...
[1] = LAYOUT(
     KC_TAB, XXXXXXX,    KC_7,    KC_8,    KC_9, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   XXXXXXX, XXXXXXX, KC_BSPC,
     KC_ESC,    KC_0,    KC_4,    KC_5,    KC_6, XXXXXXX, KC_LEFT, KC_DOWN,   KC_UP,   KC_RGHT, XXXXXXX, XXXXXXX,
...
[4] = LAYOUT(
     KC_TAB, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MPRV, KC_MNXT,   KC_MPLY, XXXXXXX, XXXXXXX,
     KC_ESC, XXXXXXX, XXXXXXX, XXXXXXX, KC_PGDN, XXXXXXX, XXXXXXX, KC_VOLD, KC_VOLU,   KC_MUTE, XXXXXXX, XXXXXXX,
    KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PGUP, XXXXXXX, KC_BRID, KC_BRIU,   XXXXXXX, XXXXXXX, KC_RSFT,
