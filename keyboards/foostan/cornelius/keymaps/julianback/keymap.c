...
[0] = LAYOUT(
      ...
      LCTL_T(KC_ESC),    KC_A,    KC_S,    KC_D, LT(1, KC_F),  KC_G,    KC_H,   KC_J,    KC_K,    KC_L, KC_SCLN,   RCTL_T(KC_QUOT),
             KC_LSFT,    KC_Z,    KC_X,    KC_C,        KC_V,  KC_B,    KC_N,   KC_M, KC_COMM,  KC_DOT, KC_SLSH, RSFT_T(KC_BSLASH),
             XXXXXXX, KC_LCTL, KC_LOPT, KC_LCMD,      KC_ENT, MO(1), KC_BSPC, KC_SPC, KC_RCMD, KC_ROPT, KC_RCTL,           XXXXXXX
  ),
